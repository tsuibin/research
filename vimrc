...
" => C section
""""""""""""""""""""""""""""""
au FileType c nmap <buffer>  <F5> :!clear;tcc -run `pkg-config --libs-only-l --cflags-only-I gtk+-3.0 dbus-glib-1 gio-2.0 ` -lsqlite3 -lxcb %<CR>
...
au FileType python nmap <buffer>  <F5> :!clear;python2 %<CR>
