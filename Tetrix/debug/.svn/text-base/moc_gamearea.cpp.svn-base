...
**
** Created: Mon Dec 21 14:46:12 2009
...
static const char qt_meta_stringdata_GameArea[] = {
    "GameArea\0\0moveTimer_upDate()\0"
};

const QMetaObject GameArea::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_GameArea,
      qt_meta_data_GameArea, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GameArea::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GameArea))
