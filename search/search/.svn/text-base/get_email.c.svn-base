...
char * test1="<a href=\"mailto:tom@akaedu.org\">";
char * test2="<a href = \"mailto :tom@sina.com.cn\">"; //error 
...
char * get_address (char * data)
{
	...
	i = strncmp(data,"mailto:",7);

	//isn't email address,return..		
	if (i != 0)
		return NULL;

	data += strlen("mailto:");

	//get email start address
	c = get_char(data);
	while (c == ' ' || c == '\"')
	{
		data++;
...
int main (char argc,char **argv)
{
	...
	printf ("Welcome use get email program! \n");
