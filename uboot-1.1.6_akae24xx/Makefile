...
$(obj)u-boot:		depend version $(SUBDIRS) $(OBJS) $(LIBS) $(LDSCRIPT)
		...
		cd $(LNDIR) && $(LD) $(LDFLAGS) $$UNDEF_SYM $(__OBJS) \
			--start-group $(__LIBS) -lgcc --end-group $(PLATFORM_LIBS) \
...
akae2410_config	:	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm920t akae2410 NULL s3c24x0

akae2440_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm920t akae2440 NULL s3c24x0
