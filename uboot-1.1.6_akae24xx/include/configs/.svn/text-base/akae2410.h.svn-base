 ...
 *
 * Configuation settings for the akaedu 2410 board.
 *
...
#define CFG_UBOOT_SIZE            0x40000  /*uboot max size*/
...
#define CONFIG_AKAE2410		1	/* on a akae2410 Board  */
...
#define CONFIG_BOOTARGS    	"root=ramfs console=ttySAC0,115200" 
...
#define CONFIG_IPADDR		172.20.149.94
#define CONFIG_SERVERIP		172.20.149.91
...
#define	CFG_PROMPT		"AKAE2410# "	/* Monitor Command Prompt	*/
...
//#define MTDIDS_DEFAULT		"nand0=akae2410-nand"
//#define MTDPARTS_DEFAULT		"akae2410-nand:192k(u-boot),8k(u-boot_env),2M(kernel),2M(splash),-(jffs2)"
