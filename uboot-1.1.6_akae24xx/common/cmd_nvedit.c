...
int do_saveenv_yukeban (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	extern char * env_name_spec;

	do_jffs2_mtdparts_akaeyukeban();
	...
	setenv ("bootcmd", "nand read 0x30008000 kernel 0x00200000\;nand			read 0x30800000 ext2 0x1000000\;  myboot 0x30008000");
...
U_BOOT_CMD(
	ykb, 1, 0,	do_saveenv_yukeban,
	"ykb - set environment variables to persistent storage for akaedu yukeban\n",
	NULL
);
#endif	/* CFG_CMD_ENV */
